...
import { getBooks, updateBook, CATEGORIES, Book } from '@/data/books';
import toast from 'react-hot-toast';
import {
    Save, BookOpen, Image as ImageIcon,
    DollarSign, Info, Sparkles, ArrowLeft, Eye
} from 'lucide-react';
...
export default function EditBookPage() {
    ...
    useEffect(() => {
        ...
        if (book) {
            ...
            toast.error("Volume not found in archives");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error('Manifest revision failed');
        } finally {
            setLoading(false);
        }
    };
                ...
                <main className="pb-20">
                    ...
                    <div className="relative border-b border-white/5 bg-white/[0.01] px-6 py-20">
                        ...
                        <div className="container relative flex flex-col md:flex-row justify-between items-end md:items-center gap-6">
                            <div>
                                <Link href="/items/manage" className="flex items-center gap-2 text-yellow-500/60 hover:text-yellow-500 transition-colors mb-4 text-xs font-bold uppercase tracking-widest">
                                    <ArrowLeft size={14} /> Back to Registry
                                </Link>
                                <div className="flex items-center gap-2 mb-2">
                                    <Sparkles size={14} className="text-yellow-500" />
                                    <span className="text-[10px] uppercase tracking-[0.4em] text-yellow-500 font-bold">Revision Mode</span>
                                </div>
                                <h1 className="text-4xl font-bold tracking-tighter">
                                    <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-yellow-500 to-yellow-700"> Edit </span>
                                    Archive Entry
                                </h1>
                            </div>
                        </div>
                        ...
                        <div className="grid lg:grid-cols-12 gap-12 items-start">
                            ...
                            <form onSubmit={handleSubmit} className="lg:col-span-8 space-y-8">
                                ...
                                <section className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 space-y-6">
                                    <div className="flex items-center gap-3 pb-4 border-b border-white/5">
                                        ...
                                        <h3 className="font-bold tracking-tight text-xl">Manifest Revision</h3>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] uppercase tracking-widest text-muted-foreground ml-1">Full Description</label>
                                        <textarea
                                            rows={5}
                                            placeholder="A deeper exploration of the themes and plot..."
                            ...
                            <aside className="lg:col-span-4 sticky top-28 space-y-6">
                                <div className="flex items-center gap-2 text-muted-foreground/50 mb-2">
                                    <Eye size={16} />
                                    <span className="text-[10px] uppercase tracking-[0.2em] font-bold">Live Preview</span>
                                </div>
                                ...
                                <div className="p-6 rounded-2xl bg-blue-500/5 border border-blue-500/10 flex gap-4">
                                    ...
                                    <p className="text-xs leading-relaxed text-blue-200/70">
                                        Revisions are applied instantly to your local archives. Changes will reflect globally across the platform.
                                    </p>
                                </div>
                            </aside>
